...
/// \param completion A block object to be executed when the server connection sequence ends. This block has no return value and takes a single <code>NSError</code> argument that indicates whether or not the connection to the server succeeded.
///
- (void)statusSubscribeWithConferenceID:(NSString * _Nonnull)confID completion:(void (^ _Nullable)(NSError * _Nullable))completion;
/// Unsubscribe the conference status notification.
/// \param conferenceID Conference ID.
///
/// \param completion A block object to be executed when the server connection sequence ends. This block has no return value and takes a single <code>NSError</code> argument that indicates whether or not the connection to the server succeeded.
///
- (void)statusUnsubscribeWithConferenceID:(NSString * _Nonnull)confID completion:(void (^ _Nullable)(NSError * _Nullable))completion;
...
/// \param conferenceID Conference ID.
///
/// \param fireInterval Useful when replaying the conference with on offset (in milliseconds). Allows the video stream to be more or less reactive depending on the length of the record.
///
/// \param completion A block object to be executed when the server connection sequence ends. This block has no return value and takes a single <code>NSError</code> argument that indicates whether or not the connection to the server succeeded.
///
- (void)startRecordingWithConferenceID:(NSString * _Nonnull)confID fireInterval:(NSInteger)fireInterval completion:(void (^ _Nullable)(NSError * _Nullable))completion;
